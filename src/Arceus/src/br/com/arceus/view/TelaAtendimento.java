...
public class TelaAtendimento extends JFrame {
	...
	public TelaAtendimento() {
		...
		lblEndereo.setBounds(10, 95, 55, 14);
		...
		lblTelefone.setBounds(10, 149, 45, 14);
		...
		lblCelular.setBounds(220, 149, 46, 14);
		...
		lblNomeDoProjeto.setBounds(237, 27, 106, 14);
		panel_3.add(lblNomeDoProjeto);

		textField_11 = new JTextField();
		textField_11.setBounds(335, 24, 398, 20);
		panel_3.add(textField_11);
		textField_11.setColumns(10);

		JLabel lblNumeroDoProjeto = new JLabel("N\u00BA do Projeto:");
		lblNumeroDoProjeto.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		lblTermino.setBounds(366, 58, 58, 14);
		...
		btnCancelar.setBounds(123, 180, 98, 23);
