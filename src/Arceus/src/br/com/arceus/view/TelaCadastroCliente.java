...
public class TelaCadastroCliente extends JFrame {
	...
	public TelaCadastroCliente() {
		...
		JComboBox boxTipoCliente = new JComboBox();
		boxTipoCliente.setModel(new DefaultComboBoxModel(new String[] {"F\u00EDsico", "Jur\u00EDdico"}));
		boxTipoCliente.setBounds(401, 59, 63, 20);
		painelDeComponentes.add(boxTipoCliente);
		
		JLabel lblTipoDeCliente = new JLabel("Tipo de Cliente");
		lblTipoDeCliente.setBounds(309, 62, 82, 14);
		painelDeComponentes.add(lblTipoDeCliente);
		
		campoCpfCnpj = new JTextField();
		campoCpfCnpj.setBounds(474, 59, 123, 20);
		...
		labelDataDeCadastro.setBounds(10, 62, 91, 14);
		...
		JComboBox boxCituaçãoCliente = new JComboBox();
		boxCituaçãoCliente.setModel(new DefaultComboBoxModel(new String[] {"ATIVO", "INATIVO"}));
		boxCituaçãoCliente.setBounds(401, 88, 119, 20);
		painelDeComponentes.add(boxCituaçãoCliente);
		
		JLabel lblCituao = new JLabel("Citua\u00E7\u00E3o");
		lblCituao.setBounds(345, 91, 46, 14);
		painelDeComponentes.add(lblCituao);
